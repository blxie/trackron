...
class SequenceDataset2(torch.utils.data.IterableDataset):
    ...
    def __init__(self,
        ...
        # Normalize
        self.p_total = sum(p_datasets)
        self.p_datasets = [x / self.p_total for x in p_datasets]
