...
def _configure_libraries():
    ...
    disable_cv2 = int(os.environ.get("TRACKER_DISABLE_CV2", False))
    if disable_cv2:
...
def setup_environment():
    ...
    the $TRACKER_ENV_MODULE environment variable, that performs
    ...
    custom_module_path = os.environ.get("TRACKER_ENV_MODULE")
...
def setup_custom_environment(custom_module):
    ...
    if custom_module.endswith(".py"):
        module = _import_file("tracker.utils.env.custom_module", custom_module)
    else:
