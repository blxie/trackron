...
# from trackron.utils.file_io import PathManager
...
def configurable(init_func=None, *, from_config=None):
    ...
    def check_docstring(func):
        if func.__module__.startswith("tracker"):
            assert func.__doc__ is not None, f"configurable {func} should be marked experimental"
        #   assert (
